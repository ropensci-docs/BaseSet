...
and [`sets()`](https://docs.ropensci.org/BaseSet/reference/sets.md)
slots.
...
[`naming()`](https://docs.ropensci.org/BaseSet/reference/naming.md). All
methods work with fuzzy and non-fuzzy sets
...
and [`nSets()`](https://docs.ropensci.org/BaseSet/reference/nSets.md)
methods.
...
## Session info
    ...
    #> [1] dplyr_1.2.1        BaseSet_1.0.0.9001
    #> 
    ...
    #> [29] pillar_1.11.1     magrittr_2.0.5    bslib_0.12.0      tools_4.6.0      
